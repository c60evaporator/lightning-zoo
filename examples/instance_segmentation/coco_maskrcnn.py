...
from lightning_zoo.datamodule.instance_segmentation.coco import CocoInstanceSegDataModule
...
# Datamodule
datamodule = CocoInstanceSegDataModule(batch_size=int(BATCH_SIZE/NUM_GPU), num_workers=NUM_WORKERS, root=DATA_ROOT,
                                       train_annFile='../detection/ann_validation/COCO/filtered_ann/instances_train_filtered.json',
                                       val_annFile='../detection/ann_validation/COCO/filtered_ann/instances_val_filtered.json',
