...
class VOCInstanceSegDataModule(InstanceSegDataModule):
    ...
    def _get_datasets(self, ignore_transforms=False):
        ...
        train_dataset = VOCInstanceSegmentation(
            self.root, out_fmt=self.out_fmt, image_set='train', download=False,
        ...
        val_dataset = VOCInstanceSegmentation(
            self.root, out_fmt=self.out_fmt, image_set='val', download=False,
        ...
        test_dataset = VOCInstanceSegmentation(
            self.root, out_fmt=self.out_fmt, image_set='val', download=False,
